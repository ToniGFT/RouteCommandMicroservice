...
public class RouteResponseService {
    ...
    public Mono<ResponseEntity<Route>> buildCreatedResponse(Route route) {
        return Mono.fromCallable(() -> RouteResponseBuilder.generateCreatedResponse(route));
    }
    ...
    public Mono<ResponseEntity<Void>> buildNoContentResponse() {
        return Mono.just(RouteResponseBuilder.generateNoContentResponse());
    }
